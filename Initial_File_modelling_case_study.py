...
def main(tpl_of_drone, enable_extension_1=False, enable_extension_2=False):
    ...
    if total_drones > 0 and model_data["max_drones_in_air"] <= total_drones:
        # Getting Value for "tpl_base_rate" from parameters
        model_data["drones"] = [{**drone, "tpl_base_rate": parameters["base_rates_gross_in_percent"]["liability"]}
        ...
        model_data["detachable_cameras"] = calculate_detachable_camera_values(model_data["drones"],
        ...
        model_data["net_prem"] = calculate_net_premium(model_data["drones"], model_data["detachable_cameras"],
                                                       model_data["net_prem"])
